...
<tr>
	...
	<td>
		<html:text styleId="text" property="poolName" size="50" maxlength="1000"/>
		<html:hidden property="countryId"></html:hidden>
	</td>
</tr>
<tr>
<td colspan="5" align="center"> <html:submit onclick= "return addPool();" property="action"><bean:message key="app.edit"/></html:submit>
</td>
