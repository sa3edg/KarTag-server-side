...
public class AcceptTripProcessor extends FileOrderProcessor {

	/**
	 * create class logger
	 */
	private static LocalLogger logger = LocalLogger.getLogger(AcceptTripProcessor.class);
	...
	public Response process() {
		...
		try {
			...
			String result = dao.acceptJoinRequest(
